      ...
      <main className="flex-1 max-w-lg mx-auto w-full px-5 py-6 space-y-5">
        ...
        <section>
          ...
          <button
            ...
            className="w-full text-left rounded-2xl border-2 border-[#0F6E56]/40 bg-gradient-to-r from-[#E1F5EE]/50 to-[#FAFAF8] dark:from-[#0F6E56]/10 dark:to-[#171613] dark:border-[#0F6E56]/30 px-5 py-4 hover:border-[#0F6E56] hover:shadow-md transition-all duration-150 active:scale-[0.98] group relative overflow-hidden"
          >
            <span className="absolute -top-1 -right-1 bg-duo-orange text-white text-[10px] font-black px-2 py-0.5 rounded-bl-xl rounded-tr-xl">
              BARU
            </span>
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-[#0F6E56] flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                </div>
                <div>
                  <p className="font-black text-sm text-duo-charcoal dark:text-gray-100 group-hover:text-[#0F6E56] dark:group-hover:text-[#E1F5EE] transition-colors">
                    Bab 6 — OS Taxonomy Prototype
                  </p>
                  <p className="text-xs text-duo-gray mt-0.5">
                    Persamaan Linear · Pelajaran interaktif berperingkat (6.1)
                  </p>
                </div>
              </div>
              <svg className="w-4 h-4 text-[#0F6E56] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" />
              </svg>
            </div>
          </button>
          <button
            ...
            className="w-full text-left rounded-2xl border-2 border-duo-teal/40 bg-gradient-to-r from-duo-teal/5 to-duo-green/5 dark:from-duo-teal/10 dark:to-duo-green/10 dark:border-duo-teal/30 px-5 py-4 hover:border-duo-teal hover:shadow-md transition-all duration-150 active:scale-[0.98] group relative overflow-hidden"
          >
            <span className="absolute -top-1 -right-1 bg-duo-orange text-white text-[10px] font-black px-2 py-0.5 rounded-bl-xl rounded-tr-xl">
              BARU
            </span>
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-duo-teal to-duo-green flex items-center justify-center flex-shrink-0">
                  <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                ...
                <div>
                  <p className="font-black text-sm text-duo-charcoal dark:text-gray-100 group-hover:text-duo-teal-dark dark:group-hover:text-duo-teal transition-colors">
                    Bab 6 — Pelajaran Interaktif
                  </p>
                  <p className="text-xs text-duo-gray mt-0.5">
                    Persamaan Linear · 24 halaman interaktif (6.1)
                  </p>
                </div>
              </div>
              <svg className="w-4 h-4 text-duo-teal flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
