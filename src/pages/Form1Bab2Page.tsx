...
export function Form1Bab2Page() {
  ...
  useEffect(() => {
    async function load() {
      try {
        const [idx, progs] = await Promise.all([fetchChapterIndex(1, 2), getAllLessonProgress()])
        setIndex(idx)
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <AppHeader tajuk="Tingkatan 1 — Bab 2" showBack backTo="/" />
      ...
      <main className="flex-1 max-w-lg mx-auto w-full px-5 py-6 space-y-6">
        ...
        <div className="rounded-2xl bg-gradient-to-br from-duo-blue to-duo-blue-dark text-white p-6 shadow-lg">
          ...
          <h2 className="text-2xl font-black mt-1">Faktor dan Gandaan</h2>
          <p className="text-white/80 text-sm mt-1">
            Faktor Perdana, FSTB, Gandaan Sepunya dan GSTK
          </p>
          {totalCount > 0 && (
